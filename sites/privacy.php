<div class="politykaPrywatnosci">
    ...
    <div class="lh166">
        ...
        <ol>
            <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>cmanager.pl</b></li>
            <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Damian Woźniak Hrubieszowska 37, 22-113 Kamień</li>
            <li>Adres kontaktowy poczty elektronicznej operatora: wozniakdamian131@gmail.com</li>
            ...
            <ul>
                <li>Identyfikacja użytkownika w aplikacji służącej do obsługi chatu online</li>
        ...
        <ol>
            <li>W niektórych sytuacjach Administrator ma prawo przekazywać Twoje dane osobowe innym odbiorcom, jeśli będzie to niezbędne do wykonania zawartej z Tobą umowy lub do zrealizowania obowiązków ciążących na Administratorze. Dotyczy to takich grup odbiorców:<ul>
